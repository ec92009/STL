# STL Codex Review 2026-05-18

Reviewed: 2026-05-18 00:00 Europe/Madrid

1/ General architecture:
- The repo appears to mix source scripts and generated STL/3MF artifacts in the same areas.
- A clearer split between `src/`, `models/`, `outputs/`, and `archive/` would make regeneration and review easier.
- Each model script should declare parameters, dependencies, units, and generated outputs.

2/ UI:
- No UI is present, which is acceptable for geometry scripts.
- The practical interface is filenames and artifacts; these should be predictable and documented.
...
- A one-command regenerate path would prevent stale `.prev` files from becoming accidental references.
- Output dimensions and units should be explicit everywhere.
